...
void callBack1(const geometry_msgs::PoseStamped &callBackData) {
  ...
  geometry_msgs::PoseStamped middlevalue;
  middlevalue = callBackData;
  middlevalue.pose.position.x = 0.79219;
  middlevalue.pose.position.y = -0.030793;
  middlevalue.pose.position.z = 0.069585;
  middlevalue.pose.orientation.x = 0.13889;
  middlevalue.pose.orientation.y = 0.96911;
  middlevalue.pose.orientation.z = 0.011025;
  middlevalue.pose.orientation.w = 0.20351;



  KDL::Frame end_effector_pose;
  KDL::Frame end_effector_pose_rot;
  tf::poseMsgToKDL(middlevalue.pose, end_effector_pose);
...
int main(int argc, char** argv)
{
  ...
  //ros::Subscriber subscriber = nodeHandle.subscribe("/aruco_tracker/pose", 10, callBack1);
